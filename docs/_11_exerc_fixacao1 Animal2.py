# VERSÃO SEM MÉTODOS ABSTRATOS
# Usa uma lista global na classe pai
...
class Animal():
    ...
    def emite_som(self):
        return f'{self.__class__.__name__} {Animal.lista_anim}'
    
    def __str__(self):
        return f'\n{self.__class__.__name__} {Animal.lista_anim}'
...
if __name__ == "__main__":
    ...
    lista = ['gato', 'ornitorinco', 'pinguium', 'aguia']
    animais = Animal(lista)
